...
2x concentration (0.67 M cobalt, 1.33 M others), same as last time.

New placement in the reservoir (to avoid contamination):
- cobalt in A1
- triazole in A3
- thiocyanate in A5
- ethanol in A7
...
Failure mode:
- SunLab Vial Rack could be mismeasured, causing a spillage. Stop protocol and replace with the placeholder.
