...
- Antisolvent is supported, and a volume of it is required (set it to zero and it will be automatically skipped).

## Desired features

- *datalab* integration: ideally, the sample data could be generated in the *datalab* interface, and robot actions could be relayed back to *datalab*.
- hi matt